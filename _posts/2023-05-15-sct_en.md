...
mentioned only if they benefit the manufacturer. Ingredients are printed in unreadably small fonts on the packaging 
...
Therefore, Micromata has developed an idea for a system focused on supply chain transparency or Supply Chain Transparency (SCT). T
he concept presented below and the resulting SCT system aim to enable manufacturers to label comparable products according to 
uniform criteria and make supply chains transparent. Transparency is rewarded through a point-based system, but opacity is neither 
